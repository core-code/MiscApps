...
task ("help", function()
{
    ...
    colorPrint("SPPredicateEditor - Framework", "bold+green");
    colorPrint("--------------------------------------------------------------------------", "bold+green");
