...
@implementation SPRuleEditorModelTest : OJTestCase
{
}

-(SPRuleEditorModel)_setupListModel
{
/*
	0.Simple
	1.Simple
	...
	4.Simple 
*/
	var model=[[SPRuleEditorModel alloc] initWithNestingMode:SPRuleEditorNestingModeList];
	for(var i=0;i<5;i++)
		[model insertNewRowAtIndex:0 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:-1 criteria:nil];
	
	return model;
}

-(SPRuleEditorModel)_setupCompoundModel
{
/*
	0.Compound
		1.Simple
		...
		9.Simple 
*/
	var model=[[SPRuleEditorModel alloc] initWithNestingMode:SPRuleEditorNestingModeCompound];
	[model addNewRowOfType:SPRuleEditorRowTypeCompound criteria:nil];
	
	for(var i=0;i<5;i++)
		[model insertNewRowAtIndex:1 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:0 criteria:nil];
	
	[model insertNewRowAtIndex:3 ofType:SPRuleEditorRowTypeCompound withParentRowIndex:0 criteria:nil];

	for(var i=0;i<3;i++)
		[model insertNewRowAtIndex:4 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:3 criteria:nil];

	return model;
}

-(SPRuleEditorModel)_setupComplexCompoundModel
{
/*
	0.Compound
		1.Simple
...
*/
	...
	[model insertNewRowAtIndex:8 ofType:SPRuleEditorRowTypeCompound withParentRowIndex:0 criteria:nil];

	for(var i=0;i<3;i++)
		[model insertNewRowAtIndex:9 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:8 criteria:nil];
/*
	0.Compound
		1.Simple
		2.Simple
...
*/
	...
	[model insertNewRowAtIndex:10 ofType:SPRuleEditorRowTypeCompound withParentRowIndex:8 criteria:nil];

	for(var i=0;i<3;i++)
		[model insertNewRowAtIndex:11 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:10 criteria:nil];
...
{
	var model=[[SPRuleEditorModel alloc] initWithNestingMode:SPRuleEditorNestingModeSingle];
	
	[self assertTrue:model!=nil];
	[self assertTrue:[model nestingMode]==SPRuleEditorNestingModeSingle];
...
-(void)test_initWithNestingMode_1
{
	...
	[self assertTrue:model!=nil];
	[self assertTrue:[model nestingMode]==SPRuleEditorNestingModeList];
	[self assertTrue:[model rootLess]];
}
...
-(void)test_initWithNestingMode_2
{
	...
	[self assertTrue:model!=nil];
	[self assertTrue:[model nestingMode]==SPRuleEditorNestingModeCompound];
	[self assertFalse:[model rootLess]];
}

-(void)test_initWithNestingMode_3
{
	var model=[[SPRuleEditorModel alloc] initWithNestingMode:SPRuleEditorNestingModeSimple];

	[self assertTrue:model!=nil];
	[self assertTrue:[model nestingMode]==SPRuleEditorNestingModeSimple];
	[self assertFalse:[model rootLess]];
}
...
// Single mode
	var model=[[SPRuleEditorModel alloc] initWithNestingMode:SPRuleEditorNestingModeSingle];
	[self assertTrue:[model allowNewRowInsertOfType:SPRuleEditorRowTypeSimple withParent:nil]];
	[self assertFalse:[model allowNewRowInsertOfType:SPRuleEditorRowTypeCompound withParent:nil]];

// List mode
	model=[[SPRuleEditorModel alloc] initWithNestingMode:SPRuleEditorNestingModeList];
	[self assertTrue:[model allowNewRowInsertOfType:SPRuleEditorRowTypeSimple withParent:nil]];
	[self assertFalse:[model allowNewRowInsertOfType:SPRuleEditorRowTypeCompound withParent:nil]];

// Simple mode
	model=[[SPRuleEditorModel alloc] initWithNestingMode:SPRuleEditorNestingModeSimple];
	[model addNewRowOfType:SPRuleEditorRowTypeCompound criteria:nil];
	[self assertTrue:[model allowNewRowInsertOfType:SPRuleEditorRowTypeSimple withParent:[model rowAtIndex:0]]];
	[self assertFalse:[model allowNewRowInsertOfType:SPRuleEditorRowTypeCompound withParent:[model rowAtIndex:0]]];

// Compound mode
	model=[[SPRuleEditorModel alloc] initWithNestingMode:SPRuleEditorNestingModeCompound];
	[model addNewRowOfType:SPRuleEditorRowTypeCompound criteria:nil];
	[self assertTrue:[model allowNewRowInsertOfType:SPRuleEditorRowTypeSimple withParent:[model rowAtIndex:0]]];
	[self assertTrue:[model allowNewRowInsertOfType:SPRuleEditorRowTypeCompound withParent:[model rowAtIndex:0]]];
}
...
// Single mode
	...
	var row=[model addNewRowOfType:SPRuleEditorRowTypeSimple criteria:nil];
	...
	row=[model addNewRowOfType:SPRuleEditorRowTypeSimple criteria:nil];
...
// List mode
	...
	row=[model addNewRowOfType:SPRuleEditorRowTypeCompound criteria:nil];
...
*/
	...
	row=[model insertNewRowAtIndex:0 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:0 criteria:nil];
/*
	0.Compound
*/

	[self assertTrue:row==nil message:@"Subtest 1 failed"];  
	row=[model insertNewRowAtIndex:1 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:0 criteria:nil];
/*
	0.Compound
		1.Simple <-
*/
...
/*
	0.Compound
		...
		3.Simple 
*/
	row=[model insertNewRowAtIndex:2 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:0 criteria:nil];
...
/*
	0.Compound
		...
		4.Simple <-
*/
	row=[model insertNewRowAtIndex:4 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:0 criteria:nil];
...
/*
	0.Compound
		...
		5.Simple 
*/
	row=[model insertNewRowAtIndex:3 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:0 criteria:nil];
...
/*
	0.Compound
		...
		6.Simple 
*/
	var compoundRow=[model insertNewRowAtIndex:3 ofType:SPRuleEditorRowTypeCompound withParentRowIndex:0 criteria:nil];
...
/*
	0.Compound
		...
		7.Simple 
*/
	row=[model insertNewRowAtIndex:4 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:3 criteria:nil];
	[self assertTrue:row!=nil message:@"Subtest 8.1 failed"];
	[self assertTrue:[row depth]==2 message:@"Subtest 8.2 failed"];

	row=[model insertNewRowAtIndex:6 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:3 criteria:nil];
	[self assertTrue:row==nil message:@"Subtest 9 failed"]; 

	row=[model insertNewRowAtIndex:3 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:3 criteria:nil];
	[self assertTrue:row==nil message:@"Subtest 10 failed"]; 

	row=[model insertNewRowAtIndex:2 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:3 criteria:nil];
...
/*
	0.Compound
		...
		9.Simple 
*/
	row=[model insertNewRowAtIndex:5 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:3 criteria:nil];
...
*/
	...
	for(var i=0;i<count;i++)
	{
		...
		if(i==2)
		{
			[self assertTrue:[row rowType]==SPRuleEditorRowTypeCompound];
			...
			for(var j=0;j<jcount;j++)
			{
				...
				[self assertTrue:[subrow rowType]==SPRuleEditorRowTypeSimple message:@"Subtest 14.4 failed"];
				[self assertTrue:[subrow parent]==row message:@"Subtest 14.5 failed"];
				[self assertTrue:[subrow depth]==2 message:@"Subtest 14.6 failed"];
			}
			continue;
		}
		[self assertTrue:[row rowType]==SPRuleEditorRowTypeSimple message:@"Subtest 14.7 failed"];
...
*/
	...
	{
		row=[root childAtIndex:i];
		[self assertTrue:[row rowType]==SPRuleEditorRowTypeSimple message:@"Subtest 6.2 failed"];
...
*/
	...
	{
		row=[root childAtIndex:i];
		[self assertTrue:[row rowType]==SPRuleEditorRowTypeSimple message:@"Subtest 5.2 failed"];
...
*/
	...
	[self assertTrue:[row rowType]==SPRuleEditorRowTypeCompound message:@"Subtest 1.3 failed"];
...
*/
	...
	{
		row=[root childAtIndex:i];
		[self assertTrue:[row rowType]==SPRuleEditorRowTypeSimple message:@"Subtest 2.3 failed"];
...
*/
	...
	[model insertNewRowAtIndex:5 ofType:SPRuleEditorRowTypeCompound withParentRowIndex:3 criteria:nil];
	[model insertNewRowAtIndex:6 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:5 criteria:nil];
	[model insertNewRowAtIndex:6 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:5 criteria:nil];
	[model insertNewRowAtIndex:6 ofType:SPRuleEditorRowTypeSimple withParentRowIndex:5 criteria:nil];
...
*/
	...
	[self assertTrue:[row rowType]==SPRuleEditorRowTypeCompound message:@"Subtest 4.3 failed"];
	...
	[self assertTrue:[subrow rowType]==SPRuleEditorRowTypeCompound message:@"Subtest 4.7 failed"];
...
*/
	...
	[self assertTrue:[row rowType]==SPRuleEditorRowTypeCompound message:@"Subtest 5.3 failed"];
...
*/
	...
	row=[root childAtIndex:0];
	[self assertTrue:[row rowType]==SPRuleEditorRowTypeSimple message:@"Subtest 6.3 failed"];
...
*/
	...
	{
		row=[root childAtIndex:i];
		[self assertTrue:[row rowType]==SPRuleEditorRowTypeSimple message:@"Subtest 4.3 failed"];
		[self assertTrue:[row parent]==root message:@"Subtest 4.4 failed"];
		[self assertTrue:[row depth]==1 message:@"Subtest 4.5 failed"];
	}
}
